      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="flex gap-1 p-1 bg-slate-100 rounded-xl w-fit mb-8">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 ${activeTab === 'online' ? 'bg-white text-blue-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 ${activeTab === 'physical' ? 'bg-white text-blue-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>
            ...
            padding={false}>
              ...
              <div className="p-5">
                <div className="flex items-center gap-2 mb-2">
                  <Badge variant={levelColor(cls.level) as any}>
                    {cls.level}
                  </Badge>
                  {cls.branch &&
      ...
      <Modal
        ...
        <div className="space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant={levelColor(selectedClass.level) as any}>
                {selectedClass.level}
              </Badge>
              <Badge variant="info">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-sm text-slate-600">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-600" /> Core
                  Concepts & Practice
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-600" />{' '}
